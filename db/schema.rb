...
ActiveRecord::Schema.define(:version => 20110512155258) do
  ...
  add_index "due_dates", ["metareview_allowed_id"], :name => "idx_review_of_review_allowed"
  ...
  add_index "topic_deadlines", ["metareview_allowed_id"], :name => "idx_review_of_review_allowed"
